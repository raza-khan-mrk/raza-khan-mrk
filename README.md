...
<div align="center">
  <img src="./assets/banner.svg" width="100%" alt="Animated intro banner" />
</div>
...
When the laptop closes, the camera comes out. My visual work is where I explore the world beyond the terminal — the streets, the faces, the light.
...
**See the work:** [Portfolio](https://my-portfolio-website-mrk6.vercel.app/) · [Instagram](https://instagram.com/raza.xthetic) · [YouTube](https://youtube.com/@your_handle) ·
...
Whether you need a **website that ships** or **visuals that stop the scroll** — let's talk.
...
<!-- ═══════════════════════════════════════════════════════════════ -->
<!--                  ANIMATED WAVE FOOTER (COLORFUL)                  -->
<!-- ═══════════════════════════════════════════════════════════════ -->

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:FF0080,15:FF8C00,35:FFD700,55:32CD32,75:00BFFF,100:8A2BE2&height=200&section=footer&text=Thanks%20for%20visiting!&fontColor=ffffff&fontSize=32&animation=twinkling&fontAlignY=65&desc=Frame+by+frame%2C+commit+by+commit&descSize=16&descAlignY=85" width="100%" alt="footer" />
